...
class BibleApp(tk.Tk):
    def __init__(self):
        ...
        self.current_translation = "kjv.csv"
        ...
        button_style.configure('Tall.TButton', padding=(1, 1))  # horizontal and vertical padding
        self.copy_notes_button = ttk.Button(notes_frame, text="Copy Notes",
                                          command=self.copy_notes,
                                          style='Tall.TButton')
        self.copy_notes_button.grid(row=0, column=3, padx=5, sticky="w", ipadx=1, ipady=1)  # internal padding
